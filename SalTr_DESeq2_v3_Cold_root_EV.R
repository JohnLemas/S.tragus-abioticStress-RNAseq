...
cts_contrast <- cts[,c(10:12,22:24,34:36)]
...
metadata_contrast <- read.table("01_input/S.tragus_metadata_v3_root_Cold.txt", header = FALSE)
...
pdf("03_output/05_DESeq2/Figure_files/Cold_root/Evolcano_0_6.pdf",
    width = 8, height = 8)

par(mfrow = c(1,1))

EnhancedVolcano(toptable = res_0_6, lab = rownames(res_0_6), 
                x = 'log2FoldChange',
                y = "pvalue",
                title = 'Differentially Expressed Genes',
                subtitle = 'I. Cold treated root tissue 6 HAT',
...
pdf("03_output/05_DESeq2/Figure_files/Cold_root/Evolcano_0_24.pdf",
    width = 8, height = 8)
...
EnhancedVolcano(toptable = res_0_24, lab = rownames(res_0_24), 
                ...
                y = "pvalue",
                title = 'Differentially Expressed Genes',
                subtitle = 'J. Cold treated root tissue 24 HAT',
                caption = bquote(~Log[2]~ "fold change cutoff = ±2; p-value cutoff = p < 0.05"),
                xlab = bquote(~Log[2]~ 'fold change'),
                selectLab = c('SalTrChr04Bg304260',
                              'SalTrChr08Ag184120',
                              'SalTrChr05Ag121400',
                              'SalTrChr04Bg313440',
                              'SalTrChr03Ag065930',
