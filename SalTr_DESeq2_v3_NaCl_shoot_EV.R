...
cts_contrast <- cts[,c(1:3,13:15,25:27,37:39)]
...
metadata_contrast <- read.table("01_input/S.tragus_metadata_v3_shoot_NaCl.txt", header = FALSE)
...
########## Enhanced volcano tutorial:
# https://bioconductor.org/packages/devel/bioc/vignettes/EnhancedVolcano/inst/doc/EnhancedVolcano.html
# Basic enhanced volcano plot:

EnhancedVolcano(res_0_3, lab = rownames(res_0_3), x = "log2FoldChange",
                y = 'pvalue')

###################### Salt treated shoot tissue updated volcano plots:

# 3 HAT

pdf("03_output/05_DESeq2/Figure_files/NaCl_shoot/Evolcano_0_3.pdf", 
    width = 8, height = 8)
...
EnhancedVolcano(toptable = res_0_3, lab = rownames(res_0_3), 
                ...
                subtitle = 'A. Salt treated shoot tissue 3 HAT',
                caption = bquote(~Log[2]~ "fold change cutoff = ±2; p-value cutoff = p < 0.05"),
                xlab = bquote(~Log[2]~ 'fold change'),
                selectLab = c('SalTrChr07Bg374820',
                              'SalTrChr07Bg372130',
                              'SalTrChr06Ag129910',
                              'SalTrChr02Ag028590',
                              'SalTrChr09Ag201590',
...
pdf("03_output/05_DESeq2/Figure_files/NaCl_shoot/Evolcano_0_8.pdf",
    width = 8, height = 8)
...
EnhancedVolcano(toptable = res_0_8, lab = rownames(res_0_8), 
                ...
                y = "pvalue",
                title = 'Differentially Expressed Genes',
                subtitle = 'B. Salt treated shoot tissue 8 HAT',
                caption = bquote(~Log[2]~ "fold change cutoff = ±2; p-value cutoff: p < 0.05"),
                xlab = bquote(~Log[2]~ 'fold change'),
                selectLab = c('SalTrChr03Ag059800',
                              'SalTrChr03Ag074460',
                              'SalTrChr06Bg349590',
                              'SalTrChr06Ag141140',
                              'SalTrChr08Ag172830',
...
pdf("03_output/05_DESeq2/Figure_files/NaCl_shoot/Evolcano_0_24.pdf",
    width = 8, height = 8)
...
EnhancedVolcano(toptable = res_0_24, lab = rownames(res_0_24), 
                ...
                y = "pvalue",
                title = 'Differentially Expressed Genes',
                subtitle = 'C. Salt treated shoot tissue 24 HAT',
                caption = bquote(~Log[2]~ "fold change cutoff = ±2; p-value cutoff = p < 0.05"),
                xlab = bquote(~Log[2]~ 'fold change'),
                selectLab = c('SalTrChr02Bg247620',
                              'SalTrChr07Bg374820',
                              'SalTrChr07Bg372130',
                              'SalTrChr05Ag106450',
                              'SalTrChr01Ag006170',
