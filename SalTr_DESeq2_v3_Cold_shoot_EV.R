...
cts_contrast <- cts[,c(7:9,19:21,31:33)]
...
metadata_contrast <- read.table("01_input/S.tragus_metadata_v3_shoot_Cold.txt", header = FALSE)
...
pdf("03_output/05_DESeq2/Figure_files/Cold_shoot/Evolcano_0_6.pdf",
    width = 8, height = 8)
...
EnhancedVolcano(toptable = res_0_6, lab = rownames(res_0_6), 
                ...
                subtitle = 'G. Cold treated shoot tissue 6 HAT',
...
pdf("03_output/05_DESeq2/Figure_files/Cold_shoot/Evolcano_0_24.pdf",
    width = 8, height = 8)
...
EnhancedVolcano(toptable = res_0_24, lab = rownames(res_0_24), 
                ...
                y = 'pvalue',
                title = 'Differentially Expressed Genes',
                subtitle = 'H. Cold treated shoot tissue 24 HAT',
                caption = bquote(~Log[2]~ "fold change cutoff = ±2; p-value cutoff = p < 0.05"),
                selectLab = c('SalTrChr05Bg336460',
                              'SalTrChr07Bg375940',
                              'SalTrChr04Ag090610',
                              'SalTrChr08Ag183670',
                              'SalTrChr05Ag121400',
